            ...
            <div className="container grid gap-6 mx-auto lg:grid-cols-2 xl:grid-cols-5">
                ...
                <div className="xl:col-span-3 h-full">
                    <Image 
                        width={800} 
                        height={400} 
                        src="/assets/Service/imagem4.jpg" 
                        alt="Limpeza Profissional" 
                        className="object-cover w-full h-full rounded-md bg-primeira" 
                    />
                </div>

                <div className="w-full px-3 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 bg-white flex flex-col justify-between">
                    <span className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl text-gray-700">Services</span>
