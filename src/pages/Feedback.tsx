...
export default function Feedback() {
    ...
    return (
        <section className="bg-segunda pt-20">
                ...
                <div className="flex flex-col p-4 md:p-20 space-y-6 rounded-sm lg:w-2/3 xl:w-3/5">
                    ...
                    <div className="flex space-x-2 sm:space-x-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="leading-snug text-gray-600">Quick and efficient service for your home.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-2 sm:space-x-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="leading-snug text-gray-600">Keep your business spotless.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-2 sm:space-x-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="leading-snug text-gray-600">Customize the service according to your preferences and schedule.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-2 sm:space-x-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="leading-snug text-gray-600">Choose the best contact method for you: Phone, SMS, WhatsApp, or Email?</p>
                        </div>
                    </div>
                </div>

                <div className="lg:w-2/3 xl:w-3/5 bg-segunda">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="flex flex-col items-center w-full">
                                    ...
                                    <div className="flex flex-col w-full">
                                        ...
                                        <button type="submit" className="py-4 my-4  rounded-md text-gray-100" style={{ backgroundColor: '#2491E4' }}>
                                            Leave your message
                                        </button>
                                    </div>
                                </div>
